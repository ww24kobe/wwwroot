                             ...
                             <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="password"  required="required" id="User_password" type="password" value="" />         
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_password2">密码确认</label></td>
                                        <td>
                                            <input class="inputBg" size="25" name="repassword" required="required" id="User_password2" type="password" />
                                        </td>
