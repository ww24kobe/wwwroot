                                ...
                                <table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
                                    <tbody><tr>
									       ...
									       <div id="city_4">
												...
												<option value="<?php  echo $addressdata['province'];?>"> <?php  echo $addressdata['province'];?></option>
												</select> 
												<select name="city" class="city" >
												<option value="<?php  echo $addressdata['city'];?>"><?php  echo $addressdata['city'];?></option>
												</select>
												<select name="district" class="dist" >
												<option value="<?php  echo $addressdata['district'];?>"><?php  echo $addressdata['district'];?></option>
												</select>
											</div>
                                                (必填) </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="consignee" class="inputBg" id="consignee_0" value="<?php  echo $addressdata['consignee'];?>" type="text" />
                                                (必填) </td>
                                            <td align="right" bgcolor="#ffffff">电子邮件地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="email" class="inputBg" id="email_0" value="<?php  echo $addressdata['email'];?>" type="text" />
                                                (必填)</td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">详细地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="address" class="inputBg" id="address_0" value="<?php  echo $addressdata['address'];?>" type="text" />
                                                (必填)</td>
                                            <td align="right" bgcolor="#ffffff">邮政编码：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="zipcode" class="inputBg" id="zipcode_0" value="<?php  echo $addressdata['zipcode'];?>" type="text" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">电话：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="tel" class="inputBg" id="tel_0" value="<?php  echo $addressdata['tel'];?>" type="text" />
                                                (必填)</td>
                                            <td align="right" bgcolor="#ffffff">手机：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="mobile" class="inputBg" id="mobile_0" value="<?php  echo $addressdata['mobile'];?>" type="text" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">标志建筑：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="sign_building" class="inputBg" id="sign_building_0" type="text" value="<?php  echo $addressdata['sign_building'];?>" /></td>
                                            <td align="right" bgcolor="#ffffff">最佳送货时间：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="best_time" class="inputBg" id="best_time_0" value="<?php  echo $addressdata['best_time'];?>" type="text" />
                                            </td>
                                        </tr>
                                        <tr>
