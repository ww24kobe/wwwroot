                ...
                <div class="box">
                    <div class="box_1">
                        <div class="userCenterBox boxCenterList clearfix" style="">
                            ...
                            <div class="blank"></div>
                            <form action="__URL__/writeaddress" method="post" name="theForm">
                                    ...
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="consignee" required class="inputBg" id="consignee_0" value="" type="text" />
                                                (必填) </td>
                                            <td align="right" bgcolor="#ffffff">电子邮件地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="email" required class="inputBg" id="email_0" value="" type="email" />
                                                (必填)</td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">详细地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="address" required class="inputBg" id="address_0" value="" type="text" />
                                                (必填)</td>
                                            <td align="right" bgcolor="#ffffff">邮政编码：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="zipcode" required class="inputBg" id="zipcode_0" value="" type="text" /></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="mobile" required class="inputBg" id="mobile_0" value="" type="text" /></td>
                                        </tr>
                                        <tr>
