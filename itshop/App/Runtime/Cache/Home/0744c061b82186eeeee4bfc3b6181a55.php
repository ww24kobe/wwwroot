...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>爱购商城 - Powered by WangweiongDa</title>
    ...
    <body class="index_body">
        ...
        <div class="block block1">  
            ...
            <div class="block box">
                <div class="blank"></div>
                <div id="ur_here">
                    当前位置: <a href="/">首页</a> <code>&gt;</code> 修改密码
                </div>
            </div>
            <div class="blank"></div>
                             ...
                             <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:87%;">
                                            <input class="inputBg" disabled="true" size="25" name="username" required="required" id="User_username" type="text" value="<?php  echo $userinfo['username'];?>" />                  
                                            
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_user_email">原密码：</label></td>
                                        <td>
                                            <input class="inputBg"  size="25" name="password" required="required" id="User_user_email" type="password"  value="" />    
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_user_email">新密码：</label></td>
                                        <td>
                                            <input class="inputBg"  size="25" name="newpassword" required="required" id="User_user_email" type="password"  value="" />    
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_user_email">确认新密码：</label></td>
                                        <td>
                                            <input class="inputBg"  size="25" name="renewpassword" required="required" id="User_user_email" type="password"  value="" />    
                                        </td>
                                    </tr>
