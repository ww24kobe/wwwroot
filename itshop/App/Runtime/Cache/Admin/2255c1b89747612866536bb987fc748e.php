...
<body>
<h1>
    <span class="action-span"><a href="__GROUP__/Category/categoryList">商品类型列表</a></span>
    <span class="action-span1"><a href="__GROUP__">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 添加类型 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form action="__GROUP__/GoodsType/add" method="post" name="theForm" enctype="multipart/form-data">
