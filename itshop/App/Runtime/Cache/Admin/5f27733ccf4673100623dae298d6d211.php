...
.explode {
  background:url(__AIMG__/menu_minus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.collapse {
  background:url(__AIMG__/menu_plus.gif) no-repeat 0px 3px;
  font-weight:bold;
}
.menu-item {
  background:url(__AIMG__/menu_arrow.gif) no-repeat 0px 3px;
  font-weight:normal;
}
#help-title {
  font-size:14px;
    ...
    <p>
        <span style="float:right; padding:3px 5px;" >
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="__AIMG__/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
            </a>
        </span>
    ...
    <div id="menu-list">
        <ul id="menu-ul">
         <li class="explode" key="02_cat_and_goods" name="menu">
           商品类型管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/GoodsType/typeList" target="main-frame">商品类型</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            商品管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Goods/goodslist" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="__GROUP__/Goods/add" target="main-frame">添加新商品</a></li>
                   
                    <li class="menu-item"><a href="__GROUP__/Goods/trashlist" target="main-frame">商品回收站</a></li>
                </ul>
            </li>
            <li class="explode" key="08_members" name="menu">
            栏目管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Category/add" target="main-frame">添加分类</a></li>
                    <li class="menu-item"><a href="<?php echo U('Category/catList');?>" target="main-frame">分类列表</a></li>
                </ul>
            </li>
			<li class="explode" key="08_members" name="menu">
            品牌管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Brand/brandList" target="main-frame">商品品牌</a></li>
                    <li class="menu-item"><a href="__GROUP__/Brand/add" target="main-frame">添加品牌</a></li>
                </ul>
            </li>
            <li class="explode" key="04_order" name="menu">
            订单管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Order/orderList" target="main-frame">订单列表</a></li>
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Member/userlist" target="main-frame">会员列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            会员留言管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Message/meslist" target="main-frame">会员留言列表</a></li>
                </ul>
            </li>
            <li class="explode" key="02_cat_and_goods" name="menu">
            公告管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/Advert/advlist" target="main-frame">公告列表</a></li>
                    <li class="menu-item"><a href="__GROUP__/Advert/add" target="main-frame">添加公告</a></li>
                </ul>
            </li>
            <li class="explode" key="08_members" name="menu">
            会员等级管理
                <ul>
                    <li class="menu-item"><a href="__GROUP__/MemberLevel/memList" target="main-frame">会员等级列表</a></li>
                    <li class="menu-item"><a href="__GROUP__/MemberLevel/add" target="main-frame">添加会员等级</a></li>
...
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '__AIMG__/menu_minus.gif' : '__AIMG__/menu_plus.gif';
