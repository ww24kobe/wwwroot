...
<body>
<h1>
    <span class="action-span"><a href="__GROUP__/Goods/goodsList">商品列表</a></span>
    ...
    <form action="__ACTION__" method="post" name="theForm" enctype="multipart/form-data">
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                    <input type='text' name='goods_name' maxlength="20" value='<?php  echo $goodsinfo['goods_name'];?>' size='27' /> <font color="red">*</font>
                </td>
            </tr>  
            <tr>
                <td class="label">商品价格:</td>
                <td>
                    <input type='text' name='shop_price' maxlength="20" value='<?php  echo $goodsinfo['shop_price'];?>' size='27' /> <font color="red">*</font>
                </td>
            </tr> 
            <tr>
                <td class="label">库存:</td>
                <td>
                    <input type='text' name='goods_number' maxlength="20" value='<?php  echo $goodsinfo['goods_number'];?>' size='27' /> <font color="red">*</font>
                </td>
            </tr>  
            <tr>
                <td></td>
