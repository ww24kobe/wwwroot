...
<form method="post" action="" name="listForm">
    <div class="list-div" id="listDiv">
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php $i=0; foreach($mesdata as $k=>$v) {?>
            <tr class="0">
                ...
                <td  ><span><?php echo date('Y-m-d H:i:s',$v['time']);?></span></td>
                <td  align="center">
                <a href="__URL__/del/id/<?php  echo $v['id'];?>" title="移除" onclick="return confirm('确认删除此条留言吗?')">移除</a>
                </td>
            </tr>
            <?php  }?>
        </table>
