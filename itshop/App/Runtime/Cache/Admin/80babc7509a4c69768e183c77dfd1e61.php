...
<body>
<h1>
    <span class="action-span"><a href="__GROUP__/Category/catlist">商品栏目列表</a></span>
    <span class="action-span1"><a href="__GROUP__">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 编辑栏目 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <form action="__GROUP__/Category/edit" method="post" name="theForm" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" value="<?php  echo $catinfo['id'];?>" />
    </form>
</div>
