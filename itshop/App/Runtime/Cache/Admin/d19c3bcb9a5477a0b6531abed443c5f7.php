...
<frameset rows="76,*" framespacing="0" border="0">
    ...
    <frameset cols="180,*" framespacing="0" border="0" id="frame-body">
        <frame src="__URL__/menu" id="menu-frame" name="menu-frame" frameborder="no">
       
        <frame src="__URL__/main" id="main-frame" name="main-frame" frameborder="no">
    </frameset>
</frameset>
</head>
<body>
