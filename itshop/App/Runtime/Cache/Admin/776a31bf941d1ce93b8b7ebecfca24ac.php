...
<div id="header-div">
    <div id="logo-div" style="bgcolor:#000000;">
        <img src="__AIMG__/ecshop_logo.gif" alt="ECSHOP - power for e-commerce" />
        
    </div>
    <div id="submenu-div">
        <ul>
            <li><a href="javascript:" target="_blank">当前管理员:<?php  echo $_SESSION['m_username'];?></a></li>
            <li><a href="/" target="_blank">查看网店</a></li>
            <li><a href="__GROUP__/Manager/updateinfo" target="main-frame">修改个人信息</a></li>
           <!--   <li style="border-right:none"><a href="#">刷新</a></li> -->
        </ul>
        <div id="send_info">
          <!--   <a href="#" target="main-frame" class="fix-submenu">清除缓存</a> --> 
            <a href="__GROUP__/Manager/logout" onclick="return  confirm('确认退出?');" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
    <ul>
        ...
        <li><a href="__GROUP__/Message/mesList" target="main-frame">会员留言</a></li>
        <li><a href="__GROUP__/Member/userList" target="main-frame">会员列表</a></li>
