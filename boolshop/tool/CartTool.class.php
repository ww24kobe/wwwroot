...
class CartTool {
    private static $ins = null;//保存单例
    private $items = array();//保存商品的数组(二维数组)
    ...
    public static function getCart() {
        if(!isset($_SESSION['cart']) || !($_SESSION['cart'] instanceof self)) {
            $_SESSION['cart'] = self::getIns();//单例对象
        }
        return $_SESSION['cart'];//返回购物车单例对象
    }
    ...
    */
    public function addItem($id,$name,$price,$num=1) {
        ...
        $this->items[$id] = $item;//每个商品都有id 指定id商品下的数量加1
    }
